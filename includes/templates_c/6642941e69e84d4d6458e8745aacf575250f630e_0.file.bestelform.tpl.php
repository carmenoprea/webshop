<?php
/* Smarty version 3.1.29, created on 2016-04-04 22:56:49
  from "C:\wamp\www\Smarty_voorbeeld\templates\bestelform.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5702d511c66200_68511938',
  'file_dependency' => 
  array (
    '6642941e69e84d4d6458e8745aacf575250f630e' => 
    array (
      0 => 'C:\\wamp\\www\\Smarty_voorbeeld\\templates\\bestelform.tpl',
      1 => 1459802970,
      2 => 'file',
    ),
  ),
...
function content_5702d511c66200_68511938 ($_smarty_tpl) {
$_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:../templates/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>"Webform order plaatsen",'username'=>'klant'), 0, false);
?>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<label for="element_1_6">Land</label>
	</div> 
		</li>		<li id="li_2" >
			...
			<option value="" selected="selected"></option>
                ...
                <div class="container">
                    <table class="table table-bordered">
                       ...
                       <?php
$_from = $_smarty_tpl->tpl_vars['order_regels']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_row_0_saved_item = isset($_smarty_tpl->tpl_vars['row']) ? $_smarty_tpl->tpl_vars['row'] : false;
$__foreach_row_0_saved_key = isset($_smarty_tpl->tpl_vars['Id']) ? $_smarty_tpl->tpl_vars['Id'] : false;
...
?>
                        <tr bgcolor=white>
                        <td><?php echo $_smarty_tpl->tpl_vars['row']->value['productID'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['row']->value['aantal'];?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['row']->value['subtotal'];?>
</td></tr>
                        <?php
...
$_smarty_tpl->tpl_vars['Id'] = $__foreach_row_0_saved_key;
}
?>
			...
			<input type="hidden" name="INVOEREN" value="1120242" />
                        <input type="hidden" name="UITCHECKEN" />
			
			<input id="saveForm" class="button_text" type="submit" name="submit" value="BESTELLING PLAATSEN" />
		</li>
			</ul>
